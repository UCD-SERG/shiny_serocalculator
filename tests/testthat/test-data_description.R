...
test_that("HTML description for nu and eps is correctly generated", {
  output <- HTML(
    "<li><code>nu</code>: biological noise</li>
     <ul>
       <li>
         <em> Typically comes from cross-reactivity with other
         molecules or other pathogens.
         Biological noise is defined as the 95th percentile of
         the distribution of antibody
  ...
  expect_match(output, "<li><code>nu</code>: biological noise</li>")
  expect_match(output, "<li><code>eps</code>: measurement noise</li>")
})
